    ...
    <form action={formAction} className='space-y-4'>
      ...
      <div>
        ...
        <input
          ...
          className='w-full px-3 py-2 border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-ring'
      ...
      <button
        type='submit'
        disabled={isPending}
        className='bg-primary text-white px-6 py-2 rounded-lg hover:bg-primary-hover disabled:opacity-50 disabled:cursor-not-allowed'
      >
